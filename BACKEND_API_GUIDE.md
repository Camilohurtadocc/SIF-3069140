...
**⚠️ IMPORTANTE: El objeto de error DEBE estar envuelto en una propiedad `error`**
...
| `ERR_204` | **Documento duplicado** ⚠️ | Ya existe en BD |
...
| `ERR_211` | **Teléfono duplicado** ⚠️ | Ya existe en BD |
| `ERR_212` | **Correo duplicado** ⚠️ | Ya existe en BD |
...
| `ERR_302` | **SKU duplicado** ⚠️ | Ya existe en BD |
...
**⚠️ NOTA CRÍTICA:** Todos los errores DEBEN estar envueltos en `{ error: { ... } }`. El frontend busca específicamente `response.data.error` y NO procesará errores sin este wrapper.
