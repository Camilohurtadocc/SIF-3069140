...
3. **Identificación visual** - Colores y emojis para cada tipo de log
...
2. **Emojis informativos** - ✅ éxito, ⚠️ advertencia, etc.
...
- Los logs de ERROR **siempre son visibles** para facilitar soporte
- El sistema usa `import.meta.env.MODE` para detectar el entorno
- Los mensajes de toast incluyen emojis para mejor UX (✅ ⚠️ ❌)
