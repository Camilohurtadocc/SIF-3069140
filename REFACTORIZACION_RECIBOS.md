...
```bash
# Mantener el archivo actual como backup
mv src/pages/RecibosDeCaja.jsx src/pages/RecibosDeCaja_OLD.jsx

# Usar la nueva versión
mv src/pages/RecibosDeCaja_NEW.jsx src/pages/RecibosDeCaja.jsx
```
...
```bash
mv src/pages/RecibosDeCaja_OLD.jsx src/pages/RecibosDeCaja.jsx
```

Y eliminar los nuevos componentes si lo deseas.
