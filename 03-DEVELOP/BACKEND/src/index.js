...
const insertInitialProducts = async () => {
  try {
    ...
    for (const product of products) {
      ...
      if (!categoryId) {
        console.warn(`⚠️ Categoría no encontrada: ${product.categoryName} para producto ${product.sku}`);
        continue;
      }
...
// Ejecutar inserción de categorías y productos después de sincronizar modelos
// DESACTIVADO: Comentar si deseas ejecutar el seed automáticamente
// setTimeout(async () => {
