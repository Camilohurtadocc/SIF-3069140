  ...
  static async update(req, res) {
    try {
      ...
      const payload = {
        ...
        presentacion_producto: presentacionFinal !== undefined && presentacionFinal !== null && presentacionFinal !== '' ? presentacionFinal : null,
        precio_unitario: Number(precio_unitario) || 0,
        id_categoria: id_categoria ? Number(id_categoria) : null,
        estado: estado || 'activo',
        url_imagen: url_imagen !== undefined ? url_imagen : null
      };
